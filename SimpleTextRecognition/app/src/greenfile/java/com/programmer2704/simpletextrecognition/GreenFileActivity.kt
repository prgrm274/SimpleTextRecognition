...
import com.programmer2704.simpletextrecognition.databinding.ActivityFileBinding
...
class GreenFileActivity : AppCompatActivity() {
    private val b: ActivityFileBinding by lazy { ActivityFileBinding.inflate(layoutInflater) }
...
//                        }
                    ...
                    textRecognizer.process(image)
                        .addOnSuccessListener { visionText ->
                            ...
                            if (capturedExpression != null) {
                                ...
                                Log.d(TAG, result)
                                b.TEXT.text = "Expression: " + expression
    ...
    private fun extractExpression(text: String): Pair<String, String>? {
        ...
        if (matchResult != null) {
            ...
            val result =
                calculateExpression(operand1.toInt(), operator, operand2.toInt()).toString()
